...
if(isset($_POST['email'])){
    ...
    $sql = "select * from teacher where email='".$email."' AND password='".$pass."' limit 1";
    $result= mysqli_query($conn,$sql);
    if(mysqli_num_rows($result) > 0){
        $row = mysqli_fetch_assoc($result);
        $_SESSION['tfname'] = $row['tfname'];
        $_SESSION['tlname']=$row['tlname'];
        $_SESSION['tid'] = $row['id'];
        ...
        header("location: teacherlogin.php?error=Invalid Credentials, Please check it again!");
    }
}
    ...
    <div class="col s12 m4 offset-m4">
        <div class="card">  
            <form action="#safs student assignement feedback system" method="POST">
                ...
                <blockquote><h5 class="login-headtext">LOGIN FORM</h5></blockquote>
